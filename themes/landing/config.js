const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_1_TITLE: '唤醒学院',
  LANDING_HEADER_BUTTON_1_URL: 'https://blog.ajiatuo.cn',

  LANDING_HEADER_BUTTON_2_TITLE: '作者博客',
  LANDING_HEADER_BUTTON_2_URL: 'https://blog.ajiatuo.cn/',

  // 首页大图英雄板块
  LANDING_HERO_TITLE_1: '唤醒空间站',
  LANDING_HERO_P_1: '线上道场，远程疗愈',
  ...
  LANDING_HERO_BUTTON_2_LINK: 'https://docs.ajiatuo.blog/about',
  ...
  // 特性介绍
  LANDING_FEATURES_HEADER_1: '探索心灵空间',
  LANDING_FEATURES_HEADER_1_P: "如何深入自己心灵空间？<br/>理解这个世界<strong class='font-bold text-red-500'>解码</strong>情绪的设计<strong class='font-bold  text-red-500'>包容</strong>内在的感受<strong class='font-bold text-red-500'>触发</strong>然后<strong class='font-bold text-red-500'>释放</strong>痛苦;<br/>现在，只要连接这个在线道场就可产生疗愈",
