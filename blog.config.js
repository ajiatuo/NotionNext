...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '生命无尽的探索者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ajiatuo.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '565354403', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 闽ICP备666号', // 备案号 闽ICP备XXXXXXX
