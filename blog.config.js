...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '伽陀之语', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '阿伽陀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ajiatuo.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '唤醒空间', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 唤醒团队出品', // 备案号 闽ICP备XXXXXXX
